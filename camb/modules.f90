    ...
    logical WantReion
    integer nu_i,actual_massless,re_int !CK update
    ...
    if (CP%Num_nu_massive > 0) then
        ...
        if (CP%share_delta_neff) then
            ...
            ! FYCR21
            CP%T_nu_0 =(sum(CP%Nu_mass_degeneracies(1:CP%Nu_mass_eigenstates))/CP%Num_Nu_massive)**(1.0d0/4.0d0)*(4.0d0/11.0d0)**(1.d0/3.0d0)*CP%tcmb            
        end if
...
500     if (L< lmax_extrap_highl) &
    ...
    integer, parameter :: nqmax0=10 !80 !CK update !maximum array size of q momentum samples
    ...
    public thermo,thermo_nu,inithermo,vis,opac,expmmu,dvis,dopac,ddvis,lenswin, tight_tau,&
        ...
        z_star, z_drag, GetBackgroundEvolution, tight_tau_nu,opac_nu,dopac_nu, &		
         Thermo_OpacityToTime_nu !CK
    contains
